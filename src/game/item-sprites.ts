...
const ITEM_SPRITES: Record<string, Sprite> = {
  ...
  // ── Forest zone items ──
  'oakheart-blade':       sword('#7a5230', '#4a3018', '#386828', '#2a1c0e'),
  'thornfang-dagger':     dagger('#4a7028', '#2a4018', '#70c050'),
  'willow-staff':         staff('#6a8848', '#3a5028', '#90d060'),
  'grovekeeper-rod':      wand('#80c850', '#386828', '#5a3c20'),
  'gravewood-scythe':     scythe('#506838', '#304020', '#88aa60'),
  'wyrmling-claw':        gauntlet('#3e7030', '#264018', '#90d060'),
  'barkhide-plate':       bodyArmor('#5a4428', '#3a2c18', '#80b050'),
  'wolfshadow-cloak':     cloak('#2e4020', '#1c2814'),
  'fernweave-robe':       robe('#30502a', '#1e3418', '#70c050'),
  'sylvan-vestments':     robe('#48683a', '#2e4424', '#a0d880'),
  'mossbone-shroud':      cloak('#46583a', '#2c3a24'),
  'greenscale-mail':      chainArmor('#3a6030', '#70b050'),
  'heartwood-cleaver':    axe('#508838', '#2e5020', '#a8e080'),
  'kingsbane-fang':       dagger('#387028', '#1e4014', '#c0ff80'),
  'archdruid-staff':      staff('#60a040', '#365c24', '#d0ffa0'),
  'lifebloom-relic':      staff('#88c858', '#4a7030', '#ffffd0'),
  'rotwood-reaper':       scythe('#48663a', '#2a3e20', '#b0e088'),
  'emerald-wyrm-talon':   gauntlet('#2e8040', '#1a4c24', '#80ffa0'),
  'ancient-oak-aegis':    bodyArmor('#6a5028', '#443418', '#b0e070'),
  'verdant-shadow-garb':  cloak('#243a1a', '#162410'),
  'living-root-mantle':   robe('#2c5024', '#1a3414', '#90e060'),
  'blessed-grove-raiment':robe('#56804a', '#36542e', '#d0ffb0'),
  'lichen-bone-carapace': bodyArmor('#586a48', '#38462e', '#b0c890'),
  'verdant-dragonhide':   chainArmor('#2e6c34', '#90e070'),

  // ── Dungeon zone items ──
  'dungeoneer-greatsword':wideSword('#484058', '#2c2838', '#9088a0', '#201c2c'),
  'lockpick-stiletto':    dagger('#585068', '#363044', '#b0a8c8'),
  'catacomb-scepter':     staff('#504868', '#322c44', '#8878b0'),
  'crypt-censer':         wand('#a890c0', '#584878', '#403850'),
  'ossuary-scythe':       scythe('#5c5468', '#383244', '#a8a0b8'),
  'iron-fang-gauntlet':   gauntlet('#4c4458', '#2e2a38', '#9890a8'),
  'jailer-plate':         bodyArmor('#403848', '#282230', '#8880a0'),
  'cell-shadow-garb':     cloak('#2c2638', '#1a1624'),
  'warden-seal-robe':     robe('#363046', '#221e30', '#8070b0'),
  'sanctum-vestments':    robe('#4c4458', '#302a3c', '#c0b8d8'),
  'tombguard-plate':      bodyArmor('#4a4252', '#2e2936', '#9088a0'),
  'drakebone-mail':       chainArmor('#443c50', '#9088a8'),
  'oathbreaker':          wideSword('#383048', '#221c30', '#b0a0e0', '#161020'),
  'wardens-end':          dagger('#403856', '#262038', '#d0c0ff'),
  'lichbane-scepter':     staff('#564a78', '#342c4c', '#c0a8ff'),
  'redemption-rod':       wand('#d8c8f0', '#786898', '#4c4060'),
  'soulchain-reaper':     scythe('#4a4060', '#2c2640', '#c0b0e8'),
  'dungeon-wyrm-fist':    gauntlet('#443a5c', '#28223c', '#b8a8e8'),
  'darkcell-bulwark':     bodyArmor('#363044', '#201c2c', '#a898d0'),
  'gloomstalker-shroud':  cloak('#241e34', '#141020'),
  'spellbound-mantle':    robe('#2e2844', '#1a162c', '#a088e0'),
  'martyr-vestments':     robe('#564e68', '#363046', '#e0d8f8'),
  'deathwarden-plate':    bodyArmor('#403856', '#262038', '#b0a0d8'),
  'obsidian-drakemail':   chainArmor('#322c44', '#a898d8'),

  // ── Volcano zone items ──
  'magma-edge':           sword('#a04018', '#602408', '#ff8030', '#401808'),
  'cinder-fang':          dagger('#803018', '#4c1c0c', '#ff9040'),
  'flamecaller-staff':    staff('#904020', '#562410', '#ffa050'),
  'sunfire-rod':          wand('#ffc060', '#a06020', '#583010'),
  'charblack-scythe':     scythe('#602818', '#38160c', '#d06030'),
  'lavaborn-claw':        gauntlet('#883018', '#501c0c', '#ff7838'),
  'pyroclast-plate':      bodyArmor('#702c14', '#44190a', '#e06828'),
  'ashwalker-garb':       cloak('#402018', '#28120c'),
  'emberweave-robe':      robe('#582414', '#36140a', '#ff7030'),
  'flamewarded-vestments':robe('#7a3c20', '#4c2412', '#ffb070'),
  'scorchbone-plate':     bodyArmor('#5c2818', '#38180e', '#cc5c2c'),
  'moltenscale-mail':     chainArmor('#6c2c16', '#ff7838'),
  'caldera-greatblade':   wideSword('#882c10', '#521a08', '#ffa040', '#341006'),
  'phoenix-talon-daggers':twinDaggers('#a03c14', '#62240a', '#ffc060'),
  'eruption-codex':       tome('#581e0c', '#361206', '#ff8020'),
  'solar-benediction':    staff('#c06028', '#744014', '#ffe090'),
  'pyre-harvester':       scythe('#702c12', '#44190a', '#ff9848'),
  'dragonfire-fist':      gauntlet('#943414', '#58200a', '#ffb058'),
  'magma-lord-plate':     bodyArmor('#7c3014', '#4c1d0a', '#ff8838'),
  'firewalker-shroud':    cloak('#341a10', '#200f08'),
  'cinderlord-mantle':    robe('#4c1e10', '#2e1208', '#ff6828'),
  'phoenix-feather-raiment': robe('#8c4824', '#582c14', '#ffd088'),
  'ashlord-carapace':     bodyArmor('#502212', '#30140a', '#c0542a'),
  'infernal-dragonplate': chainArmor('#7c2e12', '#ff8840'),
}
